...
const MySidebar = () => {
   return (
    ...
    <div class="items-center justify-between w-64 mx-auto md:flex md:w-auto md:order-2" id="navbar-search">
    ...
    <div class="flex items-center md:order-2 md:hidden space-x-3 md:space-x-0 rtl:space-x-reverse pt-2">
        ...
        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600"
            ...
            <ul class="py-2" aria-labelledby="user-menu-button">
                <li>
                    <a href="#"
                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Dashboar</a>
                </li>
                <li>
                    <a href="#"
    ...
    <div class="h-full px-3 py-2 overflow-y-auto bg-gray-50 dark:bg-gray-800">
        ...
        <ul class="space-y-2 font-medium">
            ...
            <a href="#"
                ...
                <p id="profitloss" class="font-normal text-xl text-gray-700 dark:text-gray-300">&#36; {{totalbalance}}</p>
            </a>

            <div class="block max-w-sm p-4 px-6 pl-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-900 dark:border-gray-700">
            ...
            <div class=" {{currentlyholding}} block max-w-sm p-4 px-6 pl-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-900 dark:border-gray-700">
    ...
    <nav class="bg-gray-900 border-gray-200 dark:bg-gray-800 hidden md:block">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto pb-2 pt-2">
            <div class="flex-auto justify-center items-center">
                <div class="relative hidden w-96 mx-auto md:block">
                    <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                        <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
