        ...
        <>
            <table className="table-auto border-collapse border border-gray-300 w-full">
                ...
                <tr>
                    ...
                    <td className={`border border-gray-300 px-4 py-2 ${stockDetails?.percentChange > 0 ? 'text-green-500' : stockDetails?.change < 0 ? 'text-red-500' : ''}`}>{stockDetails?.percentChange ?? 'N/A'}%</td>
                </tr>
                </tbody>
            </table>
        </>
