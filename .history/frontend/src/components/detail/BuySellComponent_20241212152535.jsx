...
import { useStocksDetailQuery } from "../../slices/stockApiSlice";
import { use } from "react";
import { useParams } from "react-router-dom";
const BuySellComponent = () => {
  const { id } = useParams();
  const { data: stockDetails } = useStocksDetailQuery(id);
  ...
  return (
    <div className="my-4">
      ...
      <p className="text-center text-gray-500 mt-2">Subtotal Price: ${quantity * stockDetails.currentValue}</p>
