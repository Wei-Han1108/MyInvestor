    ...
    return (
        <>
          <Card className="h-96 w-full">
            <h5 className="text-xl font-bold mb-4 text-center">{stockDetails?.name ?? '未找到数据'}</h5>
            <table className="table-auto border-collapse border border-gray-300 w-full">
              <thead>
                <tr className="bg-gray-100">
                  <th className="border border-gray-300 px-4 py-2 text-left">字段</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="border border-gray-300 px-4 py-2">{stockDetails?.change ?? 'N/A'}</td>
                </tr>
                <tr>
